...
kraje_produkce = hn.group_data_by_columns(indikator_map_kraje,'ZmenaMnozstvi','Evident_Kraj','Indikator')
...
orp_produkce = hn.group_data_by_columns(indikator_map_orp,'Mnozstvi','ORP_Nazev_Evident','Indikator')
...
obce_produkce = hn.group_data_by_columns(indikator_map_obce,'ZmenaMnozstvi','Evident_Nazev','Indikator')
...
folium.Choropleth(
    ...
    name='choropleth',
    data=orp_produkce,
    columns=['ORP_Nazev_Evident', 'Mnozstvi'],
    key_on='feature.properties.NAZEV',
    fill_color='YlGn',
    fill_opacity=0.7,
    line_opacity=0.2,
    legend_name='Množství odpadu ORP'
).add_to(m)
